    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-4xl font-bold text-gray-900 mb-3">Edit Testimoni</h1>
                <p class="text-gray-600">Perbarui testimoni Anda</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Order #{{ $testimonial->order->order_number }}</p>
                        <p class="text-sm text-gray-500 mt-1">Tanggal Order: {{ $testimonial->order->created_at->format('d M Y') }}</p>
                    </div>
                </div>
            </div>
            ...
            @if($testimonial->is_approved)
                <div class="bg-green-50 border border-green-200 rounded-xl p-4 mb-8">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-semibold text-green-800">Testimoni sudah disetujui dan ditampilkan</span>
                    </div>
                </div>
            @else
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-8">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-semibold text-yellow-800">Testimoni sedang menunggu persetujuan admin</span>
                    </div>
                </div>
            @endif
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST" x-data="{ rating: {{ $testimonial->rating }}, comment: '{{ $testimonial->comment }}' }">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="rating" value="{{ $i }}" class="sr-only" x-model="rating" {{ $testimonial->rating == $i ? 'checked' : '' }} required>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-blue-800">
                                ...
                                <ul class="space-y-1 list-disc list-inside">
                                    <li>Perubahan testimoni akan ditinjau kembali oleh admin</li>
                                    <li>Status persetujuan mungkin berubah setelah edit</li>
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('testimonials.myTestimonials') }}" class="flex-1 bg-gray-200 text-gray-700 font-bold py-4 rounded-xl text-center hover:bg-gray-300 transition-all">
                            Batal
                        </a>
                        <button 
                            type="submit" 
                        ...
                        >
                            <span x-show="rating > 0 && comment.length >= 10">Simpan Perubahan</span>
