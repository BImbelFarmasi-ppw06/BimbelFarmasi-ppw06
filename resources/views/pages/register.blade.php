        ...
        <div class="mx-auto max-w-xl px-4 py-16 sm:px-6 lg:px-8 w-full">
            ...
            <div class="rounded-3xl border border-blue-200 bg-white p-10 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <div class="flex w-full flex-col gap-8">
                    ...
                    <!-- Facebook Register -->
                    <a href="{{ route('login.facebook') }}" class="inline-flex w-full items-center justify-center gap-3 rounded-full border border-blue-600 bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:bg-blue-700 hover:shadow-lg hover:scale-105" aria-label="Daftar dengan Facebook">
