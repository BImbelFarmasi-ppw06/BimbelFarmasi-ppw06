...
@section('title', 'Tambah Penjoki')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">Tambah Penjoki Baru</h1>
        <p class="mt-1 text-sm text-slate-600">Tambahkan penjoki tugas dengan link WhatsApp untuk kontak langsung.</p>
    </div>
        ...
        <form action="{{ route('admin.joki.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" name="wa_link" id="wa_link" value="{{ old('wa_link') }}" required
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              placeholder="Pengalaman, bidang yang dikuasai, dll...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
